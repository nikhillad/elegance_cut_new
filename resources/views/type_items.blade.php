      ...
      <section class="content-block default-bg">
        ...
        <div class="container no-pad-t">
          ...
          <div class="col-md-12 generic-page-header-left">
            <h6 class="left-align-header-h4">{{$objCategory->name}} > <strong>{{strtolower($objType->name)}}</strong></h6>
          </div>
          <div class="clearfix"></div>
            ...
            <div class="col-md-12 object-center">
              {{$pagination->render(route('type_page',['category'=>$objCategory->cat_code,'type_code'=>$objType->type_code]))}}
            </div>
