               ...
               <tr>
                  <td class="image hidden-xs">
                    @if($item['available'] == false)
                      <div class="thumbnail-hover-label">Sold out!</div>
                    @endif
                    <img src="data:image/jpeg;base64,{{base64_encode(thumbnailImage(DOCUMENT_ROOT.'images/products/'.strtoupper($objCartItems[$item['item_id']]->item_image[0]).'/'.$objCartItems[$item['item_id']]->item_image))}}" alt="product"/>
                  </td>
                  <td class="details">
                     <div class="clearfix">
